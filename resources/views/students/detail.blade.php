...
@section('container')
    <div class="card mt-4">
        <div class="card-body">
            ...
            <a href="{{ route('students.delete', ['student' => $student->id]) }}" type="button" class="btn btn-danger"
                onclick="confirmDelete('{{ $student->id }}')">
                Delete
            </a>
            <form id="delete-form-{{ $student->id }}" action="{{ route('students.delete', ['student' => $student->id]) }}"
